package com.imss.sivimss.dispoSalas.service.impl;

import com.google.gson.Gson;
import com.google.gson.JsonObject;
import com.google.gson.JsonParser;
import com.imss.sivimss.dispoSalas.beans.Salas;
import com.imss.sivimss.dispoSalas.exception.BadRequestException;
...
import com.imss.sivimss.dispoSalas.service.VerificarSalasService;
import com.imss.sivimss.dispoSalas.util.*;
...
public class VerificarSalasServiceImpl implements VerificarSalasService {
    ...
    @Override
    public Response<?> renovarEntrada(DatosRequest request, Authentication authentication) throws IOException {
            ...
            if (validarEstatusODS(String.valueOf(registroEntrada.getIdOds()), authentication)) {
                ...
                if (response.getCodigo() == 200) {
                    providerRestTemplate.consumirServicio(salas.modificarEstatusODS(String.valueOf(registroEntrada.getIdOds())).getDatos(),
                            urlDominioConsulta + "/actualizar", authentication);
